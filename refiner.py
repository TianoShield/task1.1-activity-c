...
def run_refinement_loop(advisory: dict, target: dict, edk2_checkout: str,
                         ...
                         skip_codeql: bool = False) -> RefinementOutcome:
    pre_fix_commit = None
    ...
    while queue and attempts < max_attempts:
        ...
        inf_relpath = os.path.relpath(gen_result["inf_path"], hbfaplus_source)
        inf_relpath = os.path.join("HBFAplus", inf_relpath)
